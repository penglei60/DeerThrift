...
public class StringUtils {
    ...
    public static String handleEmpty(String str,String defStr){
...
/**
    ...
    /**  
     * Methods: isLeastLength  
     * Description: 字符个数是否超过这个 值  
     * @exception null  
     * @param str
     * @param length
     * @return 
    ...
    public static boolean isLeastLength(String str,int length) {
        return isBlank(str)?false:(str.trim().length() < length);
    }
    
    /**  
     * Methods: getDefaultValue  
     * Description: 获得默认值    "" 或 null 
     * @exception null  
     * @return 
     * String
     */  
